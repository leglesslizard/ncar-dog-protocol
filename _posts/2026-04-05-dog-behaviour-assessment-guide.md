...
order: 5
summary:
  - "<strong>Safety (every step)</strong> — Always protect your face and neck. Keep your hand up in front of these areas. Be ready for the dog to react at any point, even if it seems very calm."
  - "<strong>General Handling</strong> — Be relaxed, light and fun. Test all areas: eyes, ears, mouth, teeth, head, neck, chest, legs, paws, toes, claws, stomach, back, tail. Watch for sensitive spots — the dog may react quickly in pain or defensively. Picking up: apply gentle pressure first; skip with elderly, very nervous, or large breeds. Restraint: gently test how the dog responds to being held. Note anything too nervous to attempt."
  - "<strong>Behaviour Around People</strong> — Observe reactions to a variety of people. With nervous dogs, ask people to ignore them and see if the dog approaches on its own. Note: keen / uninterested / shy / wary / aggressive."
  - "<strong>Children</strong> — Strays: 5+ only (rarely suitable that young). Nervous, possessive or aggressive dogs: 16+ or adult only. Always consult the kennel supervisor — they make the final decision. Children must be confident and sensible."
  - "<strong>Behaviour Around Dogs</strong> — Do a few on-lead mixes with dogs of different temperaments (calm + excitable). Assess if they could live with other dogs or are better suited as the only dog. For older dogs, pair with a compatible older dog."
  - "<strong>Other Animals</strong> — Look for prey drive. Note if focused on birds, cows, or fast-moving objects. May not be obvious during the assessment — note any prey drive behaviours seen on other walks too."
  - "<strong>Food Possession</strong> — Test in the dog's kennel. Crouch/stand side on, avoid eye contact. Slowly move your foot toward the bowl, then your hand if all is calm. You are only seeing if there is a reaction — not pushing for one. Stop at the first sign of any tension."
  - "<strong>Toy Possession</strong> — Use the same side-on, slow approach as food. Gently move your hand toward the toy. Watch for: hovering, heckles up, stiff posture, snarling, growling, snapping. If it feels safe and there are no warning signs, try taking the toy away slowly."
  - "<strong>Exercise, Play and Toys</strong> — Does the dog pull on lead? What is recall like? Are they mouthy — does it mark the skin? What do they do off lead? Is the dog toy orientated? Note play style, whether they destroy toys in the kennel (possible separation anxiety), and if they drop or bring toys back. Minimum 8–12 weeks on lead after rehoming. Very nervous or flight risk dogs: 6 months minimum."
  - "<strong>At the Vets</strong> — Note how the dog responded to the health check and vaccinations: nervous / timid / relaxed / reactive. Check vet notes on Analogue if you weren't there."
  - "<strong>Traffic</strong> — Walk to the end of the drive. Note if relaxed, wary, reactive, or panicking near traffic. Avoid wide open spaces and beaches for dog aggressive dogs."
  - "<strong>Notes Section</strong> — Recap all issues seen. Note if the dog can be left alone or shows signs of separation anxiety. Write the date. Log any aggressive or possessive behaviours on the dog's board and make sure all staff are aware."
---
