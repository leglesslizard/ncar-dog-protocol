...
summary:
  ...
  - "<strong>General Handling</strong> — Be relaxed, light and fun. Test all areas: eyes, ears, mouth, teeth, head, neck, chest, legs, paws, toes, claws, stomach, back, tail. Watch for sensitive spots — the dog may react quickly in pain or defensively."
  - "<strong>Picking Up</strong> — Apply gentle pressure first. Skip with elderly dogs, very nervous dogs, and large breeds. Note it as 'too nervous/old to attempt' if needed — that still counts."
  - "<strong>Restraint</strong> — Gently test how the dog responds to being held. Stay mindful of your face and neck throughout."
  ...
  - "<strong>Toys</strong> — Is the dog toy orientated? Test for possession using the same side-on, slow approach as food. Note play style, whether they destroy toys, and if they drop or bring toys back."
  - "<strong>Exercise and Play</strong> — Does the dog pull on lead? What is recall like? Are they mouthy — does it mark the skin? What do they do off lead? Minimum 8–12 weeks on lead after rehoming. Very nervous or flight risk dogs: 6 months minimum."
